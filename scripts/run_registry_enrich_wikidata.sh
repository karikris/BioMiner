...
export BIOMINER_WIKIDATA_MIN_DELAY_SECONDS="${BIOMINER_WIKIDATA_MIN_DELAY_SECONDS:-5.0}"
export BIOMINER_WIKIDATA_MAX_DELAY_SECONDS="${BIOMINER_WIKIDATA_MAX_DELAY_SECONDS:-30.0}"
