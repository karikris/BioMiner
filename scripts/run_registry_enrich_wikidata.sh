...
export BIOMINER_WIKIDATA_MAX_DELAY_SECONDS="${BIOMINER_WIKIDATA_MAX_DELAY_SECONDS:-120.0}"
export BIOMINER_WIKIDATA_RATE_LIMIT_COOLDOWN_SECONDS="${BIOMINER_WIKIDATA_RATE_LIMIT_COOLDOWN_SECONDS:-45.0}"
