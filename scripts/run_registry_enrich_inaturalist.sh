...
RUN_ID="${RUN_ID:-registry_enrich_inaturalist_butterflies_v1}"
export BIOMINER_INATURALIST_MIN_DELAY_SECONDS="${BIOMINER_INATURALIST_MIN_DELAY_SECONDS:-1.0}"
export BIOMINER_INATURALIST_RATE_LIMIT_COOLDOWN_SECONDS="${BIOMINER_INATURALIST_RATE_LIMIT_COOLDOWN_SECONDS:-10.0}"
