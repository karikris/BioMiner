...
- `compile_queries`: compiles deterministic Flickr text and tag query definitions from enabled registry names plus retrieval-only T5 translation candidates.
