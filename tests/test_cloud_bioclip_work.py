...
def test_enqueue_bioclip_work_from_detection_shards_only_uses_scoreable_routed_detections(tmp_path: Path) -> None:
    ...
    storage.parquet_payloads[detection_uri] = pl.DataFrame(
        [
            ...
            _detection_row(
                "photo-2", "det-2", "sha256:crop-2", "hard_negative", "detected",
                detection_route="artwork_logo_tattoo_or_other_artifact",
                routing_action="exclude",
                bioclip_route=None,
                routing_priority="none",
                routing_reason="artifact_prompt",
            ),
            _detection_row(
                "photo-3", "det-3", "sha256:crop-3", "moth_like", "detected",
                detection_route="possible_moth_or_other_insect",
                routing_action="exclude",
                bioclip_route=None,
                routing_priority="none",
                routing_reason="other_insect_prompt",
            ),
