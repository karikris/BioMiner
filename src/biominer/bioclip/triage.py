...
def _prediction_fields(prediction: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "species_top20_json": prediction.get("species_top20_json", []),
        "species_candidate_count": prediction.get("species_candidate_count"),
        "species_candidate_sources_json": prediction.get("species_candidate_sources_json"),
        "geo_candidate_cell_id": prediction.get("geo_candidate_cell_id"),
        "geo_candidate_grid_level": prediction.get("geo_candidate_grid_level"),
        "geo_candidate_fallback_level": prediction.get("geo_candidate_fallback_level"),
        "species_top1_top2_margin": _optional_float(prediction.get("species_top1_top2_margin")),
        "species_entropy": _optional_float(prediction.get("species_entropy", prediction.get("species_topk_entropy"))),
        "species_top5_rerun_json": prediction.get("species_top5_rerun_json", []),
        "species_final_top1": prediction.get("species_final_top1"),
        "species_final_top1_score": _optional_float(prediction.get("species_final_top1_score")),
        "species_final_margin": _optional_float(prediction.get("species_final_margin")),
        "species_final_entropy": _optional_float(prediction.get("species_final_entropy")),
        "species_final_evidence_summary_json": prediction.get("species_final_evidence_summary_json"),
        "family_topk_json": prediction.get("family_topk_json", []),
        "family_top1": prediction.get("family_top1"),
        "family_top1_score": _optional_float(prediction.get("family_top1_score")),
        "family_top1_top2_margin": _optional_float(prediction.get("family_top1_top2_margin")),
        "family_entropy": _optional_float(prediction.get("family_entropy")),
        "family_keep_count": prediction.get("family_keep_count"),
        "genus_topk_json": prediction.get("genus_topk_json", []),
        "genus_top1": prediction.get("genus_top1"),
        "genus_top1_score": _optional_float(prediction.get("genus_top1_score")),
        "genus_candidates_by_family_json": prediction.get("genus_candidates_by_family_json"),
        "genus_keep_count": prediction.get("genus_keep_count"),
        "genus_margin": _optional_float(prediction.get("genus_margin")),
        "genus_entropy": _optional_float(prediction.get("genus_entropy")),
...
def _empty_result_fields() -> dict[str, object]:
    return {
        ...
        "species_candidate_sources_json": None,
        "geo_candidate_cell_id": None,
        "geo_candidate_grid_level": None,
        "geo_candidate_fallback_level": None,
        "species_top1_top2_margin": None,
        "species_entropy": None,
        "species_top5_rerun_json": [],
        "species_final_top1": None,
        "species_final_top1_score": None,
        "species_final_margin": None,
        "species_final_entropy": None,
        "species_final_evidence_summary_json": None,
        "family_topk_json": [],
        "family_top1": None,
        "family_top1_score": None,
        "family_top1_top2_margin": None,
        "family_entropy": None,
        "family_keep_count": None,
        "genus_topk_json": [],
        "genus_top1": None,
        "genus_top1_score": None,
        "genus_candidates_by_family_json": None,
        "genus_keep_count": None,
        "genus_margin": None,
        "genus_entropy": None,
