...
def normalize_reviewed_label_frame(frame: pl.DataFrame) -> pl.DataFrame:
    """Return a deterministic frame that satisfies the current v2 contract."""
    ...
    raise ValueError(
        "reviewed labels do not match the current v2 schema: "
    ...
    if invalid_target_values:
        findings.append(
            _finding(
                ...
                "target_present must be Boolean or null",
